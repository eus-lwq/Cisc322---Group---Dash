...
const Team = () => {
  const members = predefinedPersons.map((el) => {
    return (
      <TeamCard
        key={el.Name}
        specializtion={el.specializtion}
        Name={el.Name}
        headURL={el.headURL}
